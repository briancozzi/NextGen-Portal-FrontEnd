  ...
  <svg xmlns='http://www.w3.org/2000/svg' width='24px' height='24px' viewBox='0 0 24 24' fill='none'>
    <g opacity='0.9'>
      <path
        ...
        fill='#484848'
      />
      <path d='M8 13.1369L8.75 13.9354L12.75 9.80589L12 9.00739L8 13.1369Z' fill='#5A5A5A' />
      <path d='M15.25 13.9354L16 13.1369L12 9.0074L11.25 9.8059L15.25 13.9354Z' fill='#5A5A5A' />
    </g>
  </svg>
);
